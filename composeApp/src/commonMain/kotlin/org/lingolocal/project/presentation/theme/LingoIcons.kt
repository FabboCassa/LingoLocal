...
internal object LingoIcons {
    ...
    val KeyboardArrowDown: ImageVector by lazy {
        materialVector("KeyboardArrowDown", "M7.41 8.59 12 13.17 16.59 8.59 18 10l-6 6-6-6z")
    }
    ...
    val Mic: ImageVector by lazy {
        materialVector("Mic", "M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm5.3-3c0 3-2.54 5.1-5.3 5.1S6.7 14 6.7 11H5c0 3.41 2.72 6.23 6 6.72V21h2v-3.28c3.28-.48 6-3.3 6-6.72h-1.7z")
    }

    val Stop: ImageVector by lazy {
        materialVector("Stop", "M6 6h12v12H6z")
    }

    val Download: ImageVector by lazy {
        materialVector("Download", "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z")
    }
